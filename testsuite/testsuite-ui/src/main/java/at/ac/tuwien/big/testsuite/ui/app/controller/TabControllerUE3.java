 ...
 */
@ApplicationScoped
public class TabControllerUE3 extends AbstractTabController {

    private static final Logger LOG = Logger.getLogger(TabControllerUE3.class.getName());
    @Inject
    ...
    public void validateAll() {
        ...
        if (file.exists() && outputDir.exists()) {
            ...
            ParameterizableTask<MavenReport, File> mavenTask = mavenTestService.buildAll(outputDir, parentTask)
                    ...
                    .setOnTaskAdded(onMavenGroupTaskAdded(TestsuiteConstants.EX_ID_LAB3));
