 ...
 * @author Christian
 */
public class LanguageAttributeValidatorTest extends BaseTest {

    @Inject
    private LanguageAttributeValidator validator;

    @Test
    public void testBoth_validateShouldContainNoEntries() throws Exception {
    ...
    public void testNoLang_validateShouldContainLangAttributeError() throws Exception {
        ...
        assertTrue(result.getEntries().iterator().next().getTitle().toLowerCase().contains("lang"));
    }
}