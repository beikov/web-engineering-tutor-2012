...
/**
 * Checks for occurance of game information test errors during the game
 *
 * @author Florian Zoubek
 */
public class GameInformationDuringGameChecklistCheck extends SeleniumChecklistCheck {
    ...
    public void passValidationResultEntry(ValidationResultEntry validationResultEntry) {
        if (inSeleniumResultType) {
            ...
            if (title != null) {
                if ((title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX + " Round count") || title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX + " Incorrect Leader")) || !title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX)) {
                    if (points > 0) {
                        points = 0;
                    }
                }
    ...
    public String getDescription() {
        return "Game information is correct during gameplay";
    }
}
