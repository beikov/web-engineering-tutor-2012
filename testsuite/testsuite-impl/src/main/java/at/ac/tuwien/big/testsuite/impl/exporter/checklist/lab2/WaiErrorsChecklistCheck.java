...
/**
 * Checks for occurance of WAI test errors
 *
 * @author Florian Zoubek
 */
public class WaiErrorsChecklistCheck implements ChecklistPointCheck {
    ...
    public void passValidationResultType(ValidationResultType resultType) {
        ...
        inspectResultType = type.startsWith("WAI");
    }
