...
/**
 * Checks for occurance of Login test errors
 * 
 * @author Florian Zoubek
 */
public class LoginChecklistCheck extends SeleniumChecklistCheck {
    ...
    public void passValidationResultEntry(ValidationResultEntry validationResultEntry) {
        if (inSeleniumResultType) {
            ...
            if (title != null) {
                if ((title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX + " Login form element")
                        || title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX + " No login message")
                        || title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX + " Expected login failed")
                        || title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX + " The logout link"))
    ...
    public String getDescription() {
        return "Login works as expected";
    }
}
