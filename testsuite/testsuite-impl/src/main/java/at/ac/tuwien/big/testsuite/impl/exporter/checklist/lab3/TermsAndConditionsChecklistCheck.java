...
/**
 * Checks for occurance of Terms and conditions test errors
 * 
 * @author Florian Zoubek
 */
public class TermsAndConditionsChecklistCheck extends SeleniumChecklistCheck{
    ...
    public void passValidationResultEntry(ValidationResultEntry validationResultEntry) {
        if (inSeleniumResultType) {
            ...
            if (title != null) {
                if ((title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX + " The terms and conditions are"))
    ...
    public String getDescription() {
        return "Terms and conditions displayed as expected";
    }
