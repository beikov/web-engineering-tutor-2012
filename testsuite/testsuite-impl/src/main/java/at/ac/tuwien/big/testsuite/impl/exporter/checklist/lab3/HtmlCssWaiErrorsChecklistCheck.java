...
/**
 * Checks for occurance of XHTML/CSS/WAI test errors
 * 
 * @author Florian Zoubek 
 */
public class HtmlCssWaiErrorsChecklistCheck implements ChecklistPointCheck{
    ...
    public void passValidationResultType(ValidationResultType resultType) {
        ...
        inspectResultType = type.startsWith("XHTML") || type.startsWith("Table")
                ...
                || type.startsWith("CSS") || type.startsWith("WAI");
    }
    ...
    public String getDescription() {
        return "No XHTML/CSS/WAI errors found";
    }
