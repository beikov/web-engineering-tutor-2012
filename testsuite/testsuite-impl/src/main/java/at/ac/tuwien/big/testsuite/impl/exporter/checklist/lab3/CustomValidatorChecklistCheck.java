...
/**
 * Checks for occurance of date of birth validation test errors
 * 
 * @author Florian Zoubek 
 */
public class CustomValidatorChecklistCheck extends SeleniumChecklistCheck{
    ...
    public void passValidationResultEntry(ValidationResultEntry validationResultEntry) {
        if (inSeleniumResultType) {
            ...
            if (title != null) {
                if ((title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX + " No date of birth error message expected")
    ...
    public String getDescription() {
        return "Custom validator works as expected";
    }
