...
/**
 * Checks for occurance of invalid dice score test errors
 * @author Florian Zoubek
 */
public class ValidDiceValueChecklistCheck extends SeleniumChecklistCheck {
    ...
    public void passValidationResultEntry(ValidationResultEntry validationResultEntry) {
        if (inSeleniumResultType) {
            ...
            if (title != null && (title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX+" Dice value") || !title.startsWith(TestsuiteConstants.KNOWN_ERROR_PREFIX))) {
                if (points > 0) {
                    points = 0;
                }
            }
    ...
    public String getDescription() {
        return "The dice score is between 1 and 3";
    }
}
