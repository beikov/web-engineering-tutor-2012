...
public class RegisterControl {
    ...
    @ManagedProperty(value = "#{rcd}")
    private RaceDriverControl rcd;
     ...
     * @return the rcd
     */
    public RaceDriverControl getRcd() {
        return rcd;
    }

    /**
     * @param rcd the {@link RaceDriverControl} to set
     */
    public void setRcd(RaceDriverControl rcd) {
        this.rcd = rcd;
    }
}
